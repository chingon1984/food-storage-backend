...
CREATE INDEX IDX_STORED_ITEM_CONTAINER_ID
    ON T_STORED_ITEM(CONTAINER_ID)
    WHERE ARCHIVED = false;

CREATE INDEX IDX_STORED_ITEM_PRODUCT_ID
    ON T_STORED_ITEM(PRODUCT_ID)
    WHERE ARCHIVED = false;

CREATE INDEX IDX_STORED_ITEM_EXPIRY_DATE
    ON T_STORED_ITEM(EXPIRY_DATE)
    WHERE ARCHIVED = false;
